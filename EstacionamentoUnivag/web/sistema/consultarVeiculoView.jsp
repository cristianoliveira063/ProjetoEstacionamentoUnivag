            ...
            <div class="container">
                <div class="row">
                    <div class="page-header">
                        <h3 style="text-align: center;font-weight: bold">Consultar registro de veículo</h3>
                    </div>
                <c:if test="${msg!=null}"> 
                    ...
                    <form id="defaultForm" method="post" class="form-horizontal" style="margin-top:50px"action="${pageContext.request.contextPath}/Controller" >
                        <div class="form-group">
                            ...
                            <div class="col-lg-5">
                                ...
                                <input type="text" class="form-control input-lg"max="50" autofocus="true" style="padding-left: 125px" name="placa" data-mask="aaa-9999" required="required" autocomplete="off" />
                                <input type="hidden"  name="acao" value="registroveiculo"   />
                                <input type="hidden"  name="logica" value="registroMovimento"   />
                            </div>
                        </div>
