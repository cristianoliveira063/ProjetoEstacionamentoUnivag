            ...
            <div class="container">
                <div class="row">
                    <div class="page-header">
                        <h3 style="text-align: center;font-weight: bold">Confirmar saída do sistema</h3>

                    </div>

                    <div class="col-lg-8 col-lg-offset-2">
                        <div class="alert alert-info" style="text-align: center">
                            <h4 style="text-align: center">Olá <strong style="font-style: italic"><c:out value="${usuarioLogado.nomeUsuario}"/></strong>,deseja sair do sistema?</h4> 
                        <a href="Controller?acao=sairSistema&logica=sair" class="btn btn-danger " ><span class="glyphicon glyphicon-ban-circle"></span>Sim</a>  
                        <a href="Controller?acao=veiculo" class="btn btn-primary "><span class="glyphicon glyphicon-exclamation-sign"></span>Não</a>
                    </div>        
