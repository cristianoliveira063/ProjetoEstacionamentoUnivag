        ...
        <jsp:include page="../menu.jsp"></jsp:include>
            ...
            <div class="container" style="margin-top: 1px">
                <div class="page-header">
                    <h3 style="text-align:center;font-weight: bold">Registro de veículo</h3>
                </div>
...
<nav style="text-align: center">
        <ul class="pagination">
            <li><a href="Controller?acao=relatoriodata&valor=0&data=${data}"><span aria-hidden="true">&laquo;</span><span class="sr-only">Primeiro</span></a></li>         
                <c:forEach var="i" begin="0" end="${totalPgn}">
                <li><a href="Controller?acao=relatoriodata&valor=${i}&data=${data}">${i+1}</a></li>
                </c:forEach>

            <li><a href="Controller?acao=relatoriodata&valor=${totalPgn}&data=${data}"><span aria-hidden="true">&raquo;</span><span class="sr-only">Último</span></a></li>
        </ul>
    </nav> 
