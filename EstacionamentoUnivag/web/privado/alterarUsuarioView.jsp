                    ...
                    <section>
                        <div class="col-lg-8 col-lg-offset-2">
                            <div class="page-header">
                                <h3 style="text-align:center;;font-weight: bold">Alterar Perfil</h3>
                            </div>
                        ...
                        <form id="defaultForm" method="post" class="form-horizontal" action="${pageContext.request.contextPath}/Controller"
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-lg-4">
                                    <input type="text" class="form-control" readonly="true" value="${usuario.nome}" name="firstName" placeholder="Primeiro nome" required data-bv-notempty-message="Informe o seu Primeiro nome" />
                                </div>
                                <div class="col-lg-4">
                                    <input type="text" class="form-control" readonly="true" value="${usuario.sobrenome}" name="lastName" placeholder="Segundo nome" required data-bv-notempty-message="Informe o seu Segundo nome" />
                                </div>
                            </div>
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-lg-5">
                                    <input type="text" readonly="true" value="${usuario.cpf}" class="form-control" name="cpf"
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-lg-5">
                                    <input class="form-control" readonly="true"  value="${usuario.email}" name="email" type="email" data-bv-emailaddress-message="Informe um email válido" 
                                           required data-bv-notempty-message="Email é obrigatório"/>
                                </div>
                            </div>

                            <div class="form-group">
                                <label class="col-lg-3 control-label">Perfil de acesso</label>
                                <div class="col-lg-5">
                                    <select class="form-control" name="perfil" data-bv-notempty data-bv-notempty-message="Selecione um Perfil de  acesso">
                                        <option value="${usuario.perfil}"> ${usuario.perfil == 1 ? "ADMINISTRADOR" : "USUARIO"}</option>
                            ...
                            <input type="hidden" name="acao" value="alterarUsr" />
